...
import org.lazan.t5.stitch.select2.AjaxSettings;
import org.lazan.t5.stitch.select2.ChoiceProvider;
import org.lazan.t5.stitch.select2.Response;
import org.lazan.t5.stitch.select2.Settings;
import org.lazan.t5.stitch.select2.json.JsonBuilder;
...
public class Select2 extends AbstractField {
	...
	boolean setupRender() {
		...
		if (trackedValue != null) {
			...
			value = StringUtils.join(provider.toIds(Collections.singletonList(singleValue)), ',');
		}
